...
fun registerAll() {
    ...
    registerSolverForPuzzle("day10p1", ::solveDay10P1)
    registerSolverForPuzzle("day11p1", ::solveDay11P1)
    registerSolverForPuzzle("day11p2", ::solveDay11P2)
    registerSolverForPuzzle("day12", ::solveDay12)
}
